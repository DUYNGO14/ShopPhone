		    ...
		    <div class="row pt-3">
			    <div class="col-12 a-left">
			        <ul class="breadcrumb">
			            ...
			            <li><span  class="text-warning">Đánh giá</span></li>
			        </ul>
			    </div>
		    </div>
	    </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th scope="col col-md">Tên điện thoại</th>
                            <th scope="col col-md">Nội dung đánh giá</th>
                          </tr>
                        </thead>
                        <tbody>
	                      	<c:forEach items="${dsdgsp}" var="o">
	                          <tr>
	                          	<td><div class="mt-5">${o.tenkh}</div></td>
	                            <td><div class="mt-5">${o.tendt}</div></td>
	                            <td><div class="mt-5">${o.noidung}</div></td>
	                          </tr>
	                        </c:forEach>
                        </tbody>
                     </table>
