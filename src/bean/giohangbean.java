...
public class giohangbean {
	...
	public giohangbean(String madt, String tendt, Long gia, Double kichthuocman, Long pin, String maloai, String chip,
	...
	public String toString() {
		return "giohangbean [madt=" + madt + ", tendt=" + tendt + ", gia=" + gia + ", kichthuocman=" + kichthuocman
